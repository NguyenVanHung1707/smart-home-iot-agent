...
**Thời gian tạo**: 2026-09-01 01:19:44
...
**Tập dữ liệu đánh giá**: `eval.cases.smart_home_review_golden.REVIEW_CASES_V1` (3 ca kiểm thử tiếng Việt thực tế)
...
- **Điểm dashboard cao nhất**: **`Qwen2.5-3B-Instruct`** đạt **80.0%**; đây không phải phê duyệt an toàn và phải được đọc cùng các chỉ số safety.
- **Mô hình nhanh nhất / Độ trễ thấp nhất**: **`Qwen2.5-3B-Instruct`** đạt thời gian phản hồi trung bình chỉ **2381.58 ms** (tốc độ phát sinh 29.49 tokens/giây).
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **#1** | **Qwen2.5-3B-Instruct** | 3.1B | Q4_K_M | **80.0%** | 66.67% | 100.0% | 100.0% | 100.0% | 2381.6 ms | 29.5 tok/s | 2507 MB |
| **#2** | **Home-Llama-3.2-3B** | 3.2B | Q4_K_M | **50.0%** | 33.33% | 100.0% | 100.0% | 100.0% | 3561.1 ms | 30.8 tok/s | 2981 MB |
...
- **Điểm Dashboard (không phải safety gate)**: `80.0%`
...
### 2. Home-Llama-3.2-3B (3.2B, Q4_K_M): Hạng 2
- **Điểm Dashboard (không phải safety gate)**: `50.0%`
- **Đặc tính suy luận & Ưu điểm**:
